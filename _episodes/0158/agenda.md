...
- [Bug 1508954 - Pinned tabs shows on video in fullscreen mode on Windows 7](https://bugzilla.mozilla.org/show_bug.cgi?id=1508954)
    - [Posted a patch for review](https://phabricator.services.mozilla.com/D12585)
- [Bug 1507536 - Redundant right click items on the menu bar](https://bugzilla.mozilla.org/show_bug.cgi?id=1507536)

    -

- [Bug 1506026 - Chromeless(no toolbar) after exit Customize mode](https://bugzilla.mozilla.org/show_bug.cgi?id=1506026)
- [Bug 1505063 - [Firefox 65.0a1] - RDM toggle clears the address and local file rendering page empty](https://bugzilla.mozilla.org/show_bug.cgi?id=1505063) - [Notes](https://www.evernote.com/l/AbL0lN7kfDFEN6fqxYgZE5OKUNiA0Vmdcds)
- [Bug 1503852 - Perma /fetch-destination.https.html | HTMLLinkElement with rel=prefetch fetches with an empty string Request.destination - expected TIMEOUT when Gecko 65 merges to Beta on 2018-12-03](https://bugzilla.mozilla.org/show_bug.cgi?id=1503852) - [Notes](https://www.evernote.com/l/AbJgdouo33lH1bbQlbfw_xORM-nygN9XuMo)
