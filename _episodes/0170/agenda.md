...
- Update: [Bug 1444133 - Have an option to have view-source open in a separate (browser) window, not separate tab](https://bugzilla.mozilla.org/show_bug.cgi?id=1444133)
- [Bug 1536209 - Cannot re-request Picture-in-Picture on the same tab](https://bugzilla.mozilla.org/show_bug.cgi?id=1536209) - [Notes](https://www.evernote.com/l/AbKvGYthXddFdJYycxfuCTFhAmkxZNJJVaw)
