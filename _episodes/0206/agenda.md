...
- [Slow startup notification bar update](https://bugzilla.mozilla.org/show_bug.cgi?id=1614861)
- [Superfetch and Prefetch Telemetry](https://bugzilla.mozilla.org/show_bug.cgi?id=1610560)
- Static about:home explorations

**Rate this episode: ****https://forms.gle/7G9tSWZTuAt6ViqM7**

**Chat**

- [Join us on Matrix!](https://matrix.to/#/!enWuAmKDOEEPYejXRk:mozilla.org?via=mozilla.org&via=raim.ist) I’m only sorta monitoring the Twitch chat.
