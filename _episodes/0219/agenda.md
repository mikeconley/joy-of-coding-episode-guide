...
- Pandemic edition! I’m streaming from home! Let’s hope the wifi holds out.
- Barn Costello’s (composer of the JoC theme) [YouTube page](https://www.youtube.com/user/HermitTheFraud)
- SPECIAL CANADA DAY EPISODE NEXT WEEK with Guest [Youri Wims!](https://twitter.com/_yourijwims_)
- Update: [Bug 1622088 - Write automated tests for the about:home caching mechanism](https://bugzilla.mozilla.org/show_bug.cgi?id=1622088)
    - Pref to test out the cache: browser.startup.homepage.abouthome_cache.enabled
- [Bug 1633913 - Eliminate re-construction of Top Sites and Pocket stories when about:home startup cache loads before Activity Stream initializes](https://bugzilla.mozilla.org/show_bug.cgi?id=1633913)
- [Bug 1637791 - Show a highlight around any windows shared over WebRTC, or around the edge of the screen when sharing a screen.](https://bugzilla.mozilla.org/show_bug.cgi?id=1637791)
- Another shout out to [Compiler Compiler](https://www.twitch.tv/codehag)!
- [Codetribute](https://codetribute.mozilla.org/)
    - [First, create a Bugzilla account](https://bugzilla.mozilla.org/createaccount.cgi)

**Rate this episode: **https://forms.gle/MVbMW63pbTH2EnAv7

**Chat**

- [Join us in the Livehacking room on Mozilla’s Matrix instance!](https://matrix.to/#/!enWuAmKDOEEPYejXRk:mozilla.org?via=mozilla.org&via=raim.ist) Here’s [documentation on how to join](https://wiki.mozilla.org/Matrix). I’m only sorta monitoring the Twitch chat.
