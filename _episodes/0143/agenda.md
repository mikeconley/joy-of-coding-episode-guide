...
- Shout out to Anny! Anny is working on improvements to the DOM Clipboard API - specifically, the async variant of the API.
- Let’s clear out my review backlog
    - [Bug 1416066 - Use ScriptPreloader cache for Activity Stream for possible browser startup win](https://bugzilla.mozilla.org/show_bug.cgi?id=1416066)
        - [ScriptPreloader primer](https://mikeconley.ca/blog/2018/05/30/firefox-performance-update-9/)
...
**Rate this episode: https://goo.gl/forms/2VjSL9ADj4OeWRm63**
