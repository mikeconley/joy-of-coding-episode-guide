...
- [Bug 1724675 - The button from the “Synced Tabs” doorhanger is missing the label](https://bugzilla.mozilla.org/show_bug.cgi?id=1724675)
    - Patch posted: https://phabricator.services.mozilla.com/D122371
- [Bug 1723729 - Talos tart attempts to use chrome://tart/content/tart.ico as a favicon, but that doesn't exist.](https://bugzilla.mozilla.org/show_bug.cgi?id=1723729)
- Questions from the audience:
    ...
    - What are you looking forward to in the coming months?
        ...
        - Download Panel improvements are coming!
            - \`browser.download.improvements\_to\_download_panel\`
- I was wrong! I can stream today, but I can't stream next week.
