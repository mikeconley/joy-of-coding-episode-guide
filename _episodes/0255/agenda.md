...
- Last episode update:
    - [Bug 1712750 - Clear Recent History modal has the Old UI](https://bugzilla.mozilla.org/show_bug.cgi?id=1712750)
...
- [Bug 1717225 - Bookmarks menu popup doesn't have a border](https://bugzilla.mozilla.org/show_bug.cgi?id=1717225)
- [Bug 1720269 - The Folder icon changes its state when hovered over in about:downloads](https://bugzilla.mozilla.org/show_bug.cgi?id=1720269)
...
- [Fission](https://wiki.mozilla.org/Project_Fission) \- what is it, and how does it work, and why does it help?
