...
- Update: [Bug 1342927 - Don't wait for a layer tree if the TabChild hasn't actually been created yet](https://bugzilla.mozilla.org/show_bug.cgi?id=1342927) - [Notes](https://www.evernote.com/l/AbIftJdTjulAg6JjlUslByJqNma8NGI1gg0)
    - Actually had an impact! Hooray!
- [Bug 1344839 - Themes causing browsing failure](https://bugzilla.mozilla.org/show_bug.cgi?id=1344839) - Notes
    - https://bugzilla.mozilla.org/show_bug.cgi?id=1316632
...
**
**
**Rate this episode:** *https://goo.gl/forms/TipesHbzgOVFUX2t1*
