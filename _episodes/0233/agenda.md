...
- [Alessandro Castellani has been streaming himself livehacking on Thunderbird](https://www.youtube.com/c/AlessandroCastellani/videos)
    - [Session 1](https://www.youtube.com/watch?v=DJDBJqWAjDg), and [Session 2](https://www.youtube.com/watch?v=Y7mxJxvx7rs)
- [Bug 1666739 - PiP player is enabled when clicking Skip Ads button while PiP description is shown and the firefox window is smaller](https://bugzilla.mozilla.org/show_bug.cgi?id=1666739) - [Notes](https://www.evernote.com/l/AbLu4qb3YzVM9rte407qQuKlVG43GFMmMqw)
- [Bug 1673716 - Crash in [@ AsyncShutdownTimeout | quit-application-granted | AboutHomeStartupCache: Writing cache]](https://bugzilla.mozilla.org/show_bug.cgi?id=1673716) - [Notes](https://www.evernote.com/l/AbJdXM0E9EFHkrqHpIS9_9QELlqWGoZcs1I)
