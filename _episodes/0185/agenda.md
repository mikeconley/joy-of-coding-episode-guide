...
- [Bug 1568320 - Right-clicking on the Picture-in-Picture video toggle should reveal a context menu that allows users to disable it](https://bugzilla.mozilla.org/show_bug.cgi?id=1568320) - [Notes](https://www.evernote.com/l/AbKhc-HwcBREob7JTxurB80__yEt-83Ebpc)
- [Bug 1566183 - Picture-in-Picture player window can't be accessed with keyboard only](https://bugzilla.mozilla.org/show_bug.cgi?id=1566183) - [Notes](https://www.evernote.com/l/AbI4PlGA0HNO0IjtJ6SFi8MttYXd-iQpBBA)
- [Bug 1564359 - Add in-tree documentation for how to port from message manager and framescripts to JS Window Actors](https://bugzilla.mozilla.org/show_bug.cgi?id=1564359) - [Notes](https://www.evernote.com/l/AbJH9xfnOCRJK7scnBjQUR1ye4P5U5lhUGk)
- **No episode next week!**
- [Keyboard shortcut HUD bug](https://bugzilla.mozilla.org/show_bug.cgi?id=492557)
- [Go to Codetribute if you want to find mentored bugs to hack on](https://codetribute.mozilla.org/)
