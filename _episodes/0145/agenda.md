...
- **Vacation! Hiatus until August 8th!**
- Shout out: [Check out my colleague Les Orchard](https://www.twitch.tv/lmorchard/videos/all) hack on [Firefox Color](https://color.firefox.com/)!
    - Watch this while I’m gone!
- Bug 1469825 - Intermittent browser/components/places/tests/browser/browser_bookmarkProperties_newFolder.js | Test timed out -
    - Update - discovery!: https://bugzilla.mozilla.org/show_bug.cgi?id=1469825#c7
- Multi-select tabs pref: browser.tabs.multiselect
    - https://bugzilla.mozilla.org/show_bug.cgi?id=1474938
- [Bug 1474662 - TabChild's should be able to identify which window they're in](https://bugzilla.mozilla.org/show_bug.cgi?id=1474662) - [Notes](https://www.evernote.com/l/AbJiNxl5yxxBL4fXQe_8PMAIMmCIZZqJnE8)
    - I have this working, but I need tests!
- TODO: Attempt to reproduce and (if reproducible) file the about:printpreview bug that I noticed during the stream
- [My browser theme](https://color.firefox.com/?theme=XQAAAAL0AAAAAAAAAABBqYhm849SCiazH1KEGccwS-xNVAVPvKGAiNxTtah5dSzAMY7NzGmHfkUxcNIrZ_wYPN9WEZbZAy4tRvZRuWYQhm80LcQZZTOdLhL5yc7pW2Zj4dNy6LgWfK7PFe8TDkw1-5Ob20-NiTi_Ryu2oBEpvJE9kFK2BHbPc4QaRiB6f2FsJmxcKUXEwRtl6AfcsSppjNaoAS-qGvdPPLLUM-H46onWPoZjwmLc3wocjn4JOxhB8oQZuvjGCv9UEEAA)
...
**Rate this episode: https://goo.gl/forms/RBMqRXL2IbiWzzEG3**
