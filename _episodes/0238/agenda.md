...
- Transitioning from Evernote to [Joplin](https://joplinapp.org/)
    - I'll eventually toss the code I'm using to generate the agendas into the Episode Guide repo, once I factor out a bunch of credential stuff I hardcoded in.
...
- Review patch for [Bug 1677080 - Fullscreen PiP window is affected by switching video source](https://bugzilla.mozilla.org/show_bug.cgi?id=1677080)
- Review patch for [Bug 1687561 - Disable the skeleton UI permanently-ish if we crash during it](https://bugzilla.mozilla.org/show_bug.cgi?id=1687561)

**Rate this episode: [https://forms.gle/vWrKqdw3FQxPzjuL9](https://forms.gle/vWrKqdw3FQxPzjuL9)**
...
- Watch a developer put together a Windows game from scratch (no third-part engines) - really great explanations: [https://handmadehero.org/](https://handmadehero.org/)
