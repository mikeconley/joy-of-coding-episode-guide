...
- Better Know a Gecko: Service Workers will continue next week
- [Bug 1301104 - Add a probe for the big tab spinner for degenerate cases](https://bugzilla.mozilla.org/show_bug.cgi?id=1301104) - [Notes](https://www.evernote.com/l/AbLtPfZiENlLWZ4J_Vjjjwbx9Ibek_qMeVA)
- Review:
    - [Bug 1283384 - Implement UI for <input type="time">](https://bugzilla.mozilla.org/show_bug.cgi?id=1283384)
- [Bug 1287178 - "you have an unsubmitted crash report" even though crash reporter is disabled](https://bugzilla.mozilla.org/show_bug.cgi?id=1287178) - [Notes](https://www.evernote.com/l/AbK_hUjFgnJEhLVjPsL76b7lk_mB5BPhf0Q)
- [Bug 1275493 - [non-e10s] Do not update the combobox display text until the popup has been closed ](https://bugzilla.mozilla.org/show_bug.cgi?id=1275493)[-](https://bugzilla.mozilla.org/show_bug.cgi?id=1275493) [Notes](https://www.evernote.com/l/AbJxDMtsyWBPs5sm28LIrIbxRsalgmGcpNs)
- [Bug 1275493 - Do not update <select> field while keying through items in dropdown with non-e10s.](https://bugzilla.mozilla.org/show_bug.cgi?id=1275493)
...
**RATE THIS EPISODE: **https://goo.gl/forms/EbN46O8YhRAjPoDG2
