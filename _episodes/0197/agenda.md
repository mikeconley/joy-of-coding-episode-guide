...
- File bug to call stopTrackingMouseOverVideos in willDestroy in PictureInPictureChild, and upload patch
    - [Bug 1596169 - Run stopTrackingMouseOverVideos inside of PictureInPictureChild's willDestroy](https://bugzilla.mozilla.org/show_bug.cgi?id=1596169)
- Thumbnailer test issues
    - [Bug 1595135 - Perma browser_thumbnails_bg_image_capture.js | This test exceeded the timeout threshold. It should be rewritten or split up. If that's not possible, use requestLongerTimeout(N), but only as a last resort. when Gecko 72 merges to Beta on 2019-12-02](https://bugzilla.mozilla.org/show_bug.cgi?id=1595135)
    - [Bug 1595292 - Perma toolkit/components/thumbnails/test/browser_thumbnails_bg_image_capture.js | Uncaught exception - at chrome://content/browser/toolkit/components/thumbnails/test/head.js:247 - Error: page-thumbnail:error when Gecko 72 merges to Beta on 2019-12-02](https://bugzilla.mozilla.org/show_bug.cgi?id=1595292)
- Reviews
- [Reading Emilio’s blog post](https://crisal.io/words/2019/11/13/shutdown-leak-hunting.html) on fixing shutdown leaks in Firefox
