...
- Needinfos
    - [Bug 1575379 - \[meta\] Make it possible to capture non-warm startup times using frame recording](https://bugzilla.mozilla.org/show_bug.cgi?id=1575379)
    - [Bug 1741634 - The search box moves left and right every you type.](https://bugzilla.mozilla.org/show_bug.cgi?id=1741634)
    - [Bug 1547349 - PiP Twitter video stops when original video is scrolled out of view](https://bugzilla.mozilla.org/show_bug.cgi?id=1547349)
- Investigating some test failures
    - [Bug 1634804 - Intermittent browser/base/content/test/tabcrashed/browser\_shownRestartRequired.js | Title element exists. - null == true - JS frame :: chrome://mochitests/content/browser/browser/base/content/test/tabcrashed/browser\_shownRestartRequired.js](https://bugzilla.mozilla.org/show_bug.cgi?id=1634804)
    - [Bug 1725277 - Intermittent docshell/test/browser/browser_TopLevelNavigationDelegate.js | TopLevelNavigationDelegateParent saw the load attempt. - "undefined" == "http://example.org/2#test" - JS frame :: chrome://mochitests/content/browser/docshell/test/browser/browser](https://bugzilla.mozilla.org/show_bug.cgi?id=1725277)
