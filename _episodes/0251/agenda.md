...
- **[Bug 1711431 - Long tab title is displayed without a fade on Windows 7](https://bugzilla.mozilla.org/show_bug.cgi?id=1711431)**
- **[](https://bugzilla.mozilla.org/show_bug.cgi?id=1712219)[Bug 1672486 - Remove browser.toolbars.bookmarks.2h2020 pref and the dead code when the pref is always true](https://bugzilla.mozilla.org/show_bug.cgi?id=1672486)**
