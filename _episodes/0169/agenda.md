...
- Self-check: is everything working?
    - Hopefully I’ve fixed the video sync issue
- Update: [Bug 1529762 - Page Style menu population can delay about:home from painting](https://bugzilla.mozilla.org/show_bug.cgi?id=1529762)
    - This landed
- Update: Picture-in-Picture ended video white frame bug
    - Blocked on review
- Review: [Bug 1444133 - Have an option to have view-source open in a separate (browser) window, not separate tab,](https://bugzilla.mozilla.org/show_bug.cgi?id=1444133) - [Phabricator Review Page](https://phabricator.services.mozilla.com/D18071)
