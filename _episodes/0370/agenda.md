...
* More backup stuff!
	* Let's work on the appName / appVersion bugs and write tests
		* https://bugzilla.mozilla.org/show_bug.cgi?id=1903606
		* https://bugzilla.mozilla.org/show_bug.cgi?id=1903064
	* Let's see if we can work on the about:preferences UI for backup
* AsyncTabSwitcher priority thing
	* If we have time, we can look at https://bugzilla.mozilla.org/show_bug.cgi?id=1896172
