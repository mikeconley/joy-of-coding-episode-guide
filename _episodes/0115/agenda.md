...
- The Joy of Coding: More Live Than Usual at MozFest!
    - Not sure how this is going to work just yet, but it’s less than a month away!
    - https://mozillafestival.org/
    - https://github.com/MozillaFoundation/mozfest-program-2017/issues/142
    - Likely doing 1.5 hour chunks to keep streaming platforms happy.
- Get Firefox 57 for MEGA FASTNESS: https://www.mozilla.org/en-US/firefox/channel/desktop/
- [Let’s get that tab warming stuff working without activating the docShell](https://bugzilla.mozilla.org/show_bug.cgi?id=1397426) - [Notes](https://www.evernote.com/l/AbLOfT-bJURAxqXAs4fqUdsjcLctLBSSubI)
...
- [Bug 1399068 - Fill Login/Password through context menu doesn't work](https://bugzilla.mozilla.org/show_bug.cgi?id=1399068) - [Notes](https://www.evernote.com/l/AbLeH74Nn-dPV6k17MvkOhPEZmB7wPFcyRU)
...
**Rate this episode: https://goo.gl/forms/XW1YOTbNyvkGhUEz1**
