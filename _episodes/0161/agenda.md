...
- Happy New Year!
- [Link to theme on AMO](https://addons.mozilla.org/en-US/firefox/addon/electricbluegaloo/)
...
- [Bug 1516022 - promiseDocumentFlushed callbacks will fire even if subframes have mDelayedResize's pending](https://bugzilla.mozilla.org/show_bug.cgi?id=1516022) - [Notes](https://www.evernote.com/l/AbIUafHpQ6FPN7LTPIIJIDclS_9GEAwZEyU)
    - Writing a test case
    - Fun tip: Ctrl-x a in gdb (so that includes rr) splits the interface so that you can see the loc you’re dealing with and have a console below
