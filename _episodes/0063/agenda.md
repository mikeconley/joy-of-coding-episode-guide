...
- More review feedback for [Bug 1261842](https://bugzilla.mozilla.org/show_bug.cgi?id=1261842) - Make initial browser remote sooner if we're defaulting to using remote tabs
    - Fixed the failing test!
        - Need to find or file a new bug about window size on Windows
        - [Bug 1231070](https://bugzilla.mozilla.org/show_bug.cgi?id=1231070) - window.open size and position specs are not honored
    - Clean-up latest review feedback: https://reviewboard.mozilla.org/r/58790/
- [Bug 1096013](https://bugzilla.mozilla.org/show_bug.cgi?id=1096013) - [e10s] Improve perceived session restore duration - [Notes](https://www.evernote.com/l/AbLGnY6NB9BMm6VtioxqWUuc5ci_TUDgolQ)
...
**RATE THIS EPISODE: **http://goo.gl/forms/MWBpgm96pkycbDVq2
