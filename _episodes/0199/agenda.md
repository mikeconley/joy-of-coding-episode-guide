...
- Testing with Fission!
    - fission.autostart
    - [Fission-dogfooding bug to file against if you find problems](https://bugzilla.mozilla.org/show_bug.cgi?id=fission-dogfooding)
- [Bug 1594227 - Add menu item to open non-Fission window when Fission is enabled (and vice versa?)](https://bugzilla.mozilla.org/show_bug.cgi?id=1594227) - [Notes](https://www.evernote.com/l/AbJmgOXTH7ZAq7F7zk2_fAwG1fDhEHBc9bs)
- Examining ActivityStream
