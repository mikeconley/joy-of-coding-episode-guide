...
- [Bug 1303077 - Gather client-side stacks for the content process when the tab switch spinner is shown](https://bugzilla.mozilla.org/show_bug.cgi?id=1303077) - [Notes](https://www.evernote.com/l/AbIMUPAmYWVOPa0bxVX7190iWY_TdrAHplQ)
    - Patch up for review! Address aklotz’s review comments. Got about:telemetry to show the data
...
**RATE THIS EPISODE: **https://goo.gl/forms/tdCGFDTkEnZJfHfz2
