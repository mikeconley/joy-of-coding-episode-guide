...
- **No episode next week due to travel**
- [Bug 1422685 - 9.46 - 14.04% tps (linux64, osx-10-10, windows10-64, windows7-32) regression on push 8994162ee112a8c0a0b33f3404f04ebd9fad1285 (Sat Dec 2 2017)](https://bugzilla.mozilla.org/show_bug.cgi?id=1422685) - [Notes](https://www.evernote.com/l/AbK2Sl0ACfRBq7_W06r_BLjemkDu8ZQIv-U)
- [Bug 1423226 - Permanent tabswitch spinners when closing tabs that were opened from windows that fully occluded the browser](https://bugzilla.mozilla.org/show_bug.cgi?id=1423226)
...
- [Bug 887887 - Use Sqlite.jsm in Form History](https://bugzilla.mozilla.org/show_bug.cgi?id=887887)
...
**Rate this episode: https://goo.gl/forms/UI66pSbSJ529mRdt2**
