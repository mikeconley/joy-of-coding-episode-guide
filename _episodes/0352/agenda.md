...
* Help with [bug 1873947](https://bugzilla.mozilla.org/show_bug.cgi?id=1873947)
	* You can test out the new Screenshots backend by setting `screenshots.browser.component.enabled` to `true`
* Review https://phabricator.services.mozilla.com/D198425
* Let's convert PlacesFeed to an ESM!
* Finishing [this doc on What process is a script running in?](https://docs.google.com/document/d/1JsWvTH7A4VF81yAm5lCS45l_U1mYfLZlqZTDeXnpUro/edit#heading=h.uwiaucmm9o9f)
