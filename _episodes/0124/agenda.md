...
**Last episode of the year! I****’****m back January 10th!**
...
- [Bug 1373055 - When background tabs crash, unload them instead of flipping their remoteness and sending them to about:blank](https://bugzilla.mozilla.org/show_bug.cgi?id=1373055)
    - Mentored bug! Let’s try to figure out what Arjun is dealing with with the test failures.
    - [Code review notes](https://www.evernote.com/l/AbL9RO_KRwxL1Zbr0EF0rBUkc76_SyDcEgI)
...
- [Bug 887887 - Use Sqlite.jsm in Form History](https://bugzilla.mozilla.org/show_bug.cgi?id=887887) - [Notes](https://www.evernote.com/l/AbImEKYlZg1D4op6mBAA6Q832PGjbjBGQOo)
...
**Rate this episode: https://goo.gl/forms/3Zvljz8IrGftgPlA2**
