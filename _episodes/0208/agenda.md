...
- Music: https://freemusicarchive.org/music/Broke_For_Free/Petal
- [Bug 1621173 - Intermittent browser/base/content/test/general/browser_bug724239.js | about:newtab was added to the session history when AS was enabled. - Got false, expected true](https://bugzilla.mozilla.org/show_bug.cgi?id=1621173) - [Notes](https://www.evernote.com/l/AbKKuqOi43BAh4CH5U6jvL0HE35zuww0fxY)
- [Bug 1621032 - Add a mechanism for reading about:home from the HTTP cache if an entry exists at startup](https://bugzilla.mozilla.org/show_bug.cgi?id=1621032)
    - [Patch](https://phabricator.services.mozilla.com/D66079)
- [Bug 1614502 - Add a mechanism for producing a static version of about:home periodically that can be cached for startup.](https://bugzilla.mozilla.org/show_bug.cgi?id=1614502)
