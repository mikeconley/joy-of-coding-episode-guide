...
- Going through some needinfos
    - [Bug 1725837 - string length is too short in download panel and download speed is almost always truncated (in e.g. French and potentially other locales)](https://bugzilla.mozilla.org/show_bug.cgi?id=1725837)
    - [Bug 1739491 - Turning on slack huddles creates a XML error warning](https://bugzilla.mozilla.org/show_bug.cgi?id=1739491)
    - [Bug 1054947 - "It looks like you haven't started Firefox in a while" message despite running Firefox daily](https://bugzilla.mozilla.org/show_bug.cgi?id=1054947)
-  Questions:
