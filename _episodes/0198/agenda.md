...
- Look at startup performance profiles
    - [Notes](https://www.evernote.com/l/AbIcjrWOFfNOqbosTgA2rj0jA8-G7ynIBnY)
- [Bug 1545438 - We shouldn't disable the blocklist in talos, at least for startup tests](https://bugzilla.mozilla.org/show_bug.cgi?id=1545438)
- [Bug 1505495 - consider geckoprofiling to be run at the end of every normal test run and upload artifacts for every run](https://bugzilla.mozilla.org/show_bug.cgi?id=1505495)
- Drain review queue
