...
- Finishing up hashtable documentation patch
    - [Bug 1758753 - Migrate XPCOM hashtable documentation from MDN archive to Firefox Source Docs](https://bugzilla.mozilla.org/show_bug.cgi?id=1758753)
- mochitest alphabetization patch
    - [Bug 1756878 - Add a linting rule for mochitest.ini / browser.ini / chrome.ini files to ensure tests are in alphabetical order](https://bugzilla.mozilla.org/show_bug.cgi?id=1756878)
