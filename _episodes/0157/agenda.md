...
- Update: [Bug 1504133 - sessionrestore seems broken in general](https://bugzilla.mozilla.org/show_bug.cgi?id=1504133)
- Update: [Bug 1505314 - [Linux] Titlebar is no longer hidden](https://bugzilla.mozilla.org/show_bug.cgi?id=1505314)
