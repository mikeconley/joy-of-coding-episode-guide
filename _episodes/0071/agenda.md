...
- [Bug 1288606 - Intermittent docshell/test/browser/browser_bug670318.js | Test timed out](https://bugzilla.mozilla.org/show_bug.cgi?id=1288606) - [Notes](https://www.evernote.com/l/AbKkM7pxHCpNz4AsnlGfKpnEqe5gZuks8_U)
    - I want to use rr to debug an intermittent test
- [Bug 1287178 - Refactor unsubmitted crash report handling and allow users to always send backlogged crash reports](https://bugzilla.mozilla.org/show_bug.cgi?id=1287178)
    - Follow-up patch to fix a string comment
- **Better Know a Gecko: Service Workers!**
...
**RATE THIS EPISODE: **https://goo.gl/forms/j5MjSwLjJDSgLgll1
