...
- **Happy 100th Episode! We did it! Do you like my funny hat?**

![](images/da85c6d0963de907d2c6f75b16ab98a5)
...
- Help make Firefox Faster! https://perf-html.io/ [Gather a profile, and then](https://developer.mozilla.org/en-US/docs/Mozilla/Performance/Reporting_a_Performance_Problem)[Gimme your Performance Profiles!](https://docs.google.com/a/mozilla.com/forms/d/e/1FAIpQLSePiq1ifvrY6EzDowEdqKdb-tGGm-AvgG86ivU9ipv7FsggKQ/viewform)
    - I’ve done [two](https://air.mozilla.org/the-joy-of-profiling-pilot/)  [pilots](https://air.mozilla.org/the-joy-of-profiling-pilot-2/) so far. First official episode is this Friday. These are pre-recorded and only posted to Air Mozilla for now. Expansion is possible, just need to give it time.
- [Episode guide](https://github.com/mikeconley/joy-of-coding-episode-guide)
    - Feel free to send pull requests!
- So what were the results of the 100th Episode Survey?

![](images/018b4087538587de37b8e5d8f3e37258)

    - [Bug 566510 - Allow multiselect operations on tabs](https://bugzilla.mozilla.org/show_bug.cgi?id=566510)
        - [Notes](https://www.evernote.com/l/AbLW-TNpXEJKnYsGHEf-fJaRdUC0lFpnS6E)
        - [Source code](https://github.com/mikeconley/multi-select-tabs) for MultiSelect Tabs
        - Attempting to bake this into the browser right now is not a great idea, especially given the Photon work that’s going on. Plus, this is something that we’d need to involve UX and Product in on, and that might take a while.
        - In the mean time, we can prototype something. **Let’s design and build a WebExtension!**
...
**Rate this episode: **https://goo.gl/forms/mKFWFKbxjDdClH8N2
