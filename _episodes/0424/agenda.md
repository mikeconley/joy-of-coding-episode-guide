...
- Brought to you by [HTTP Code 424](https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Status/424)!
- Air Mozilla transcript tool!
- Let's figure out a plan for suppressing stories and top sites during the first 48 hours
	- [Bug 2009017 - Add a capability that lets us set different defaults for top sites and top stories during the first 48 hours of the default profile's lifetime](https://bugzilla.mozilla.org/show_bug.cgi?id=2009017)
