...
- Reviewing some code!
    - [Bug 1721466 - The new redesigned Clear recent history window modal lacks title](https://phabricator.services.mozilla.com/D120984)
    - [Bug 1720262 - \[Clear Recent History Modal\] Please adjust the spacing around the Cancel and OK Button area](https://phabricator.services.mozilla.com/D120985)
- Answer some questions from previous episode forms
- More cleanup bugs?
