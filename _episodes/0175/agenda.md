...
- [Picture-in-Picture issue meta bug](https://bugzilla.mozilla.org/show_bug.cgi?id=1527926)
- gdb trick to view code inline:
    - Ctrl-x a
- [Bug 1540835 - Add tests for the Picture-in-Picture toggle](https://bugzilla.mozilla.org/show_bug.cgi?id=1540835) - [Notes](https://www.evernote.com/l/AbLODwTGgD5NV7rWdfPHI20PzP_ezkzDplQ)
...
**Rate this episode: **https://forms.gle/JXZMTtvKS3mjnFP46
