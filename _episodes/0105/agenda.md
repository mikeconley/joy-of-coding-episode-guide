...
[NET NEUTRALITY](https://blog.mozilla.org/blog/2017/07/11/defending-net-neutrality-day-action/)

[OMG SAVE IT](https://advocacy.mozilla.org/en-US/net-neutrality-comments)

- Self-check: is everything working?
- [Episode guide](https://github.com/mikeconley/joy-of-coding-episode-guide)
    - Feel free to send pull requests!
- Is Vibrancy available on Yosemite?
    - It sure is - **my MBP runs Yosemite!**
- [Talos crasher for Activity Stream](https://github.com/mozilla/activity-stream/issues/2806)
    - Blocked on getting loaner set up to run Talos
- [Bug 1374333 - Ensure all Talos Pageloader tests can return Gecko Profiles for all processes when run with --geckoProfiler](https://bugzilla.mozilla.org/show_bug.cgi?id=1374333) - [Notes](https://www.evernote.com/l/AbLNjyGtSjtNapUXbs0AfSGQGbp017bMKfY)
...
**Rate this episode:** https://goo.gl/forms/cjodgHyzZH1Lhbgj1
