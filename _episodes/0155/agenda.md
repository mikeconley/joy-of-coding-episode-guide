...
- [Bug 1500619 - PageIconProtocolHandler janks the browser sometimes, especially immediately after switching window focus back to Firefox](https://bugzilla.mozilla.org/show_bug.cgi?id=1500619)
- MyQOnly?
