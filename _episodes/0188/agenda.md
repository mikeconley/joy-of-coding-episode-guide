...
- Reviewing: [Bug 1578709 - Set flash-only pref on a per-manifest/suite basis instead of for all feature tests](https://bugzilla.mozilla.org/show_bug.cgi?id=1578709)
    - Reviewed!
- [Bug 1546931 - installs.ini and profiles.ini should not be both stat'ed and read using main thread I/O during early startup](https://bugzilla.mozilla.org/show_bug.cgi?id=1546931)
    - Landed!
- [Bug 1566196 - Enable subframe crashing regression test](https://bugzilla.mozilla.org/show_bug.cgi?id=1566196)
    - [Wrote a big comment](https://bugzilla.mozilla.org/show_bug.cgi?id=1566196#c12)
