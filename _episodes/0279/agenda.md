...
- FOSDEM:
    ...
    - [https://fosdem.org/2022/schedule/event/mozilla\_firefox\_dev_101/](https://fosdem.org/2022/schedule/event/mozilla_firefox_dev_101/)
- Clearing out more needinfos and bumping some probe expiries
    - [Bug 1754640 - Remove or update probes expiring in Firefox 100: FX\_TAB\_CLOSE_* before Gecko version increases to 100 on 2022-03-08](https://bugzilla.mozilla.org/show_bug.cgi?id=1754640)
- videocontrols to Fluent! Let's close 'er out.
- Questions:
    - Tell us about the [Taburdle](https://addons.mozilla.org/en-US/firefox/addon/taburdle/) Firefox add-on that posts on your Twitter please.
