...
- Better Know a Gecko: Service Workers will continue next week or the week after
- [Bug 1298204 - Auto-complete on form fields does show some white lines or do not show up sometimes](https://bugzilla.mozilla.org/show_bug.cgi?id=1298204) - [Notes](https://www.evernote.com/l/AbLjAeuApp9C0rdNRYNvc8ytb0MDHDSGfG8)
- Bug 1275493 - Do not update <select> field while keying through items in dropdown with non-e10s.
- Review:
...
**RATE THIS EPISODE: **https://goo.gl/forms/a8sdIiZ0Jf7xNrxL2
