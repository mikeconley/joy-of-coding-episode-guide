...
- Self-check: is everything working? I surrrrre hope so.
- [Bug 1277060 - When typing in the URL bar if a parent process page is loaded and loading about:home using the toolbar button, shortcut, a bookmark, anything besides the url bar - the location bar is not cleared](https://bugzilla.mozilla.org/show_bug.cgi?id=1277060) - [Notes](https://www.evernote.com/l/AbLJTcZujp5P0LFW2yMYjSoVk2G8l4KNpLQ)

    -

- [Bug 1516022 - promiseDocumentFlushed callbacks will fire even if subframes have mDelayedResize's pending](https://bugzilla.mozilla.org/show_bug.cgi?id=1516022) - [Notes](https://www.evernote.com/l/AbIUafHpQ6FPN7LTPIIJIDclS_9GEAwZEyU)
    - This bounced, and I’d like to figure out why
- [Bug 1509250 - Session tab replaced with about:newtab if session manually restored too early after startup](https://bugzilla.mozilla.org/show_bug.cgi?id=1509250) - [Notes](https://www.evernote.com/l/AbJDM_YqoYBHfaCBYcCucVG1dMF358b_r08)
    - Figured this one out - [check out this comment](https://bugzilla.mozilla.org/show_bug.cgi?id=1509250#c28)
