...
- New AirMozilla! Old repeater! Let’s see how this works out.
- Making performance videos... trying to add timestamps with ffmpeg
    - Yes, I’m using Camtasia for video editing. Relax.
- [Bug 1661304 - Add an API for privileged front-end code to add BHR annotations](https://bugzilla.mozilla.org/show_bug.cgi?id=1661304)
