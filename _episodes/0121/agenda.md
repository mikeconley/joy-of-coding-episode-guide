...
- American viewers - guess what:

[![](images/e16a4c9ebe2c271fa02c61058f197f85)](https://www.battleforthenet.com/)

    - https://www.battleforthenet.com/
- Update: [Bug 1403563 - Tabs scrolling with mouse wheel is very, very slow](https://bugzilla.mozilla.org/show_bug.cgi?id=1403563) - [Notes](https://www.evernote.com/l/AbKFLaWwFNdJtraRhC1C6e_co9cnkcekJqU)
    - Landed and fixed!
- [Bug 1397426 - Make tab browser warming API not set the docshell to be active?](https://bugzilla.mozilla.org/show_bug.cgi?id=1397426) - [Notes](https://www.evernote.com/l/AbLOfT-bJURAxqXAs4fqUdsjcLctLBSSubI)
    - ![](images/ab6ad4545a5def47f741d6972447d1f8)
- Let’s go back to ipdl_parser! I learned some lessons from hacking on Searchfox.
    - What’s the IPDL Parser? Watch this video from almost a year ago: https://air.mozilla.org/the-joy-of-coding-episode-85/
...
**Rate this episode: https://goo.gl/forms/y8mZrm2ptrpKuZjo2**
