...
- [Bug 1447193 - Rendering error after scroll](https://bugzilla.mozilla.org/show_bug.cgi?id=1447193) - [Notes](https://www.evernote.com/l/AbIcGpsYS2VIAr9BI3vJHHtpk1Pm-owkf5U)
- [Bug 1451401 - Opening a new tab and then causing a Switch To tab from the AwesomeBar always results in a short spinner](https://bugzilla.mozilla.org/show_bug.cgi?id=1451401) - Notes
...
**Rate this episode: https://goo.gl/forms/LUBkTcit7omO6dFK2**
