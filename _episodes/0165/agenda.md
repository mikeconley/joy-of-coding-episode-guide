...
- New about:config!
    ...
    - [Source code for page](https://searchfox.org/mozilla-central/rev/9eb30227b21e0aa40d51d9f9b08bb0b113c5fadb/browser/components/aboutconfig/content/aboutconfig.js)
- [Bug 1521964 - Provide a privileged API for compositing decoded video frames onto an alternate placeholder](https://bugzilla.mozilla.org/show_bug.cgi?id=1521964) - [Notes](https://www.evernote.com/l/AbLwzcRrYiVM15OfLXcVetqqTtRA3GWAF6Y)
- [Bug 1497996 - Persist Activity Stream DOM content to disk at shutdown, and load that cache on start-up](https://bugzilla.mozilla.org/show_bug.cgi?id=1497996) - [Notes](https://www.evernote.com/l/AbJwqD8SqypGPo35Tgh2M01cp0A_d6gdzQE)
