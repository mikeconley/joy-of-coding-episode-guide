...
- [Bug 418833 - can't define the style of input when the type is set to "checkbox" or "radio" with CSS](https://bugzilla.mozilla.org/show_bug.cgi?id=418833) - [Notes](https://www.evernote.com/l/AbKrlogZK7JAI5ku_nPXCZzDTA6He5GGVFY)
    - Let’s get this passing the Android reftests!
    - Got through this! See notes for dirty details.
- Review:
    - [Bug 1300784 - Combine e10s and non-e10s <select> dropdown mechanisms](https://bugzilla.mozilla.org/show_bug.cgi?id=1300784)
- Add tests for [hidden plugin stuff](https://bugzilla.mozilla.org/show_bug.cgi?id=1186948)
...
**RATE THIS EPISODE: **https://goo.gl/forms/Nn3r2vGbJ9SxVTg63[(L)](https://goo.gl/forms/8ap5qKahowauV3EG2)
