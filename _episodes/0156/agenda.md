...
- Update: [Bug 1498233 - Password Doorhanger is not displayed using custom tabs](https://bugzilla.mozilla.org/show_bug.cgi?id=1498233)
- [Bug 1504133 - sessionrestore seems broken in general](https://bugzilla.mozilla.org/show_bug.cgi?id=1504133)
- [Bug 1505314 - [Linux] Titlebar is no longer hidden](https://bugzilla.mozilla.org/show_bug.cgi?id=1505314)
