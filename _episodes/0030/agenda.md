...
- Sorry for the skipped episode!
- Update:
    - [**Bug 1141041**](https://bugzilla.mozilla.org/show_bug.cgi?id=1141041) - [e10s] Opening the "View" > "Page Style" menu in remote browser causes unsafe CPOW usage warnings - [Notes](https://www.evernote.com/l/AbJxLoMFHhZC1rE3iYG-PL2a17CJYl1R4Sw)
- Milestone: https://bugzilla.mozilla.org/buglist.cgi?quicksearch=cf_tracking_e10s%3Am8%2B&list_id=12351245
- Coding:
    - [**Bug 1090602**](https://bugzilla.mozilla.org/show_bug.cgi?id=1090602) - [e10s] <option> events do not bubble up through parent <select> - [Notes](https://www.evernote.com/l/AbIaeqtOzshJaogk1omBE_v_Dle4IbP8a4o)
