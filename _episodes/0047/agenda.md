...
- **NO EPISODE NEXT WEEK.** I’m traveling that week and won’t be able to stream. Sorry!
- [**Bug 1251732**](https://bugzilla.mozilla.org/show_bug.cgi?id=1251732) - See if e10s regresses tpaint for windows opened from the parent process - [Notes](https://www.evernote.com/l/AbJJ3MyliPRJN4fE-7jE8sZc4xis8yST8Cw)
- Reviews:
    - [**Bug 1099156**](https://bugzilla.mozilla.org/show_bug.cgi?id=1099156) - Fix browser_bug435325.js to work on e10s (
    - [**Bug 962433**](https://bugzilla.mozilla.org/show_bug.cgi?id=962433) - Use Reader Mode for printing articles
...
**RATE THIS EPISODE: **http://goo.gl/forms/qjnHExsOqb
