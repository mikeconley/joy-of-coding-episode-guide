...
- Finishing up [Bug 1906739 - Implement scheduled backups CTA and restore your data sections in backup-settings](https://bugzilla.mozilla.org/show_bug.cgi?id=1906739)
    - We need tests!
...
- File a bug for a backup still being displayed as existing after having disabled backups and restarting
    ...
    - https://bugzilla.mozilla.org/show_bug.cgi?id=1907136
    - https://phabricator.services.mozilla.com/D216201
