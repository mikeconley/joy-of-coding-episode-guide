...
- [Bug 1566906 - Picture-in-Picture toggle should not open PiP except on primary mouse click](https://bugzilla.mozilla.org/show_bug.cgi?id=1566906)
- [Bug 1566152 - Hide the Picture-in-Picture toggle after several seconds of mouse inactivity](https://bugzilla.mozilla.org/show_bug.cgi?id=1566152) - Notes
- TODO: File bug for Twitch thing where we navigate when we don’t expect to
- [Test day on Friday July 19th, 2019! Help us test Fission!](https://quality.mozilla.org/2019/07/firefox-nightly-70-testday-july-19th/)
