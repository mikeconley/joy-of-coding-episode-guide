...
- [Bug 1686315 - Adapt modal tests so that they work with Proton modals enabled or disabled](https://bugzilla.mozilla.org/show_bug.cgi?id=1686315)
- [Hermitthefraud aka Barn](https://www.youtube.com/user/HermitTheFraud/videos)
