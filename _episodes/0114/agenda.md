...
- The Joy of Coding: More Live Than Usual at MozFest!
    - Not sure how this is going to work just yet, but it’s about a month away!
...
- [Let’s get that tab warming stuff working without activating the docShell](https://bugzilla.mozilla.org/show_bug.cgi?id=1397426) - [Notes](https://www.evernote.com/l/AbLOfT-bJURAxqXAs4fqUdsjcLctLBSSubI)
    - Fixing crashers!
    - http://rr-project.org/
    - https://groups.google.com/forum/#!searchin/mozilla.dev.platform/jemalloc%7Csort:relevance/mozilla.dev.platform/S8WA3oHB7mM/4BsGua72AQAJ
...
**Rate this episode: https://goo.gl/forms/2btFeHsl6zQHJhHC3**
