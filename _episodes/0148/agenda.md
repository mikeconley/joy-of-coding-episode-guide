...
- Insecure HTTP padlock and label:
...
- [Bug 1480951 - Cleared sessionStorage is resurrected when reopening Firefox](https://bugzilla.mozilla.org/show_bug.cgi?id=1480951) - [Notes](https://bugzilla.mozilla.org/show_bug.cgi?id=1480951)
    - HEY WE FIXED IT! Alright, posted a patch for review.
- Episode 150
    - Got ideas? Submit them in the Episode Rating form!
- **TODO: **File a bug for how crazy DevTools was today, graphically. Super-flashy!
...
**Rate this episode: https://goo.gl/forms/zrItDwNhPgAyge8f1**
