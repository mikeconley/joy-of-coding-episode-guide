...
- Help make Firefox Faster! https://perf-html.io/ [Gather a profile, and then](https://developer.mozilla.org/en-US/docs/Mozilla/Performance/Reporting_a_Performance_Problem)[Gimme your Performance Profiles!](https://docs.google.com/a/mozilla.com/forms/d/e/1FAIpQLSePiq1ifvrY6EzDowEdqKdb-tGGm-AvgG86ivU9ipv7FsggKQ/viewform)
    - [List of episodes](https://air.mozilla.org/search/?q=Joy+of+profiling)
- [Episode guide](https://github.com/mikeconley/joy-of-coding-episode-guide)
    - Feel free to send pull requests!
- [Bug 1372261](https://bugzilla.mozilla.org/show_bug.cgi?id=1372261) - Find out why tps has regressed on Win32 (Windows 7) since early May, 2017 - [Notes](https://www.evernote.com/l/AbLYbQ2q8BxKvL5qeOkglXe80WCgofa3T54)
- [Bug 1374725](https://bugzilla.mozilla.org/show_bug.cgi?id=1374725) - 2.93 - 14.92% glterrain / tp5o_scroll / tscrollx / tsvgx (osx-10-10) regression on push d521c1d8d60503c088aa4127300a83161852f297 (Tue Jun 20 2017) - [Notes](https://www.evernote.com/l/AbJDZ7QOvRtElIpAf0zGK6oPIW_D5ZyhVQE)
...
**Rate this episode:** https://goo.gl/forms/b232dAFXOpzxWmCb2
