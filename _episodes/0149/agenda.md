...
- Update:
    - [Bug 1480951 - Cleared sessionStorage is resurrected when reopening Firefox](https://bugzilla.mozilla.org/show_bug.cgi?id=1480951) - [Notes](https://bugzilla.mozilla.org/show_bug.cgi?id=1480951)
        - This landed!
    - Super-flashy DevTools graphics bug
        - [This got fixed here](https://bugzilla.mozilla.org/show_bug.cgi?id=1488889)
- [Bug 1356920 - 6.33ms uninterruptible reflow at rect@chrome://browser/content/browser-tabsintitlebar.js:106:23](https://bugzilla.mozilla.org/show_bug.cgi?id=1356920) - [Notes](https://www.evernote.com/l/AbIDAsWjYHRDdJ7FmHXJ9kgbOmbRsLr31vM)
    - https://searchfox.org/mozilla-central/source/browser/base/content/browser-tabsintitlebar.js#167
...
**Rate this episode: https://goo.gl/forms/BBVJRYr47Qxarj8j2**
