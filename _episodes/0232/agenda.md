...
- [On SpiderMonkey Warp](https://hacks.mozilla.org/2020/11/warp-improved-js-performance-in-firefox-83/)
    - TL;DR: Faster now in Firefox 83 on JS heavy sites
- News flash: [Mercurial is planning on integrating more Rust into the software stack](https://www.mercurial-scm.org/wiki/OxidationPlan)
