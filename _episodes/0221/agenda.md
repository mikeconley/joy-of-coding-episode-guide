...
- Are you interested in testing the about:home startup cache? Turn it on in about:preferences experiments, and file bugs against [this metabug](https://bugzilla.mozilla.org/show_bug.cgi?id=1614351)
- [Bug 1646958 - The text on the Global Sharing Overlay (when sharing screen) is not displayed correctly when in high contrast on Windows/dark theme on Linux](https://bugzilla.mozilla.org/show_bug.cgi?id=1646958) - Notes
- [Bug 1649032 - If the user closes the WebRTC sharing indicator, all streams should close](https://bugzilla.mozilla.org/show_bug.cgi?id=1649032) - Notes
...
**Rate this episode: **https://forms.gle/QbWFv1wzd8zECvdi9
