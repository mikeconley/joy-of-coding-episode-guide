...
- [Bug 1749345 - White screen for up to 30 sec after updating Firefox using the full installer, due to FirstStartup component](https://bugzilla.mozilla.org/show_bug.cgi?id=1749345)
