...
- **Review: **[**Bug 1214158**](https://bugzilla.mozilla.org/show_bug.cgi?id=1214158) - [Session Restore] Measure time until all tabs that are restored eagerly are restored
- **M8 - [Bug 1233497](https://bugzilla.mozilla.org/show_bug.cgi?id=1233497)** - Make unsafe CPOWs from non-addon browser code throw by default - [Notes](https://www.evernote.com/l/AbICslX4T1VPt6cB_-rwrn7hfl8e7S1PAu4)
...
**RATE THIS EPISODE:** http://goo.gl/forms/FRbNFRIXtU
