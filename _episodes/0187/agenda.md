...
- [Bug 1566196 - Subframe crashing is broken again](https://bugzilla.mozilla.org/show_bug.cgi?id=1566196)
- Thunderbird news! Version 68 came out today.
    - [New design underway?](https://invis.io/EPT0H6ZY2WD)
    - [And you can follow/join the conversation here](https://thunderbird.topicbox.com/groups/ux/Tc7a6a67754ee87b1/thunderbird-76-bonanza)
    - [Lead UX architect on Twitter](https://twitter.com/alecaddd)
- Found a Fission bug? You can file new issues blocking [this metabug](https://bugzilla.mozilla.org/show_bug.cgi?id=fission-dogfooding)
