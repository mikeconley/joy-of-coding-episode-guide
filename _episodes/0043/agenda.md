...
- We missed our **1 Year Anniversary!**
- **Review: [Bug 1243838](https://bugzilla.mozilla.org/show_bug.cgi?id=1243838)** - Fix test_contextmenu.html to run in e10s
- [**Bug 1182595**](https://bugzilla.mozilla.org/show_bug.cgi?id=1182595) - Make profile dumping work with e10s - [Notes](https://www.evernote.com/l/AbL6Q3uE4mpOWYg8NoXbSRee4BnQXkD-8M4) or the content-sessionStore.js test failure. [Notes for content-sessionStore.js](https://www.evernote.com/l/AbIDZA7wgGFIMaKU4DP_WvBL3oY-IAXJDUU)
...
**RATE THIS EPISODE: **http://goo.gl/forms/zJGxpkIHKH
