...
- No green screen today - can't get the lighting right, and lagging. I'll try again soon.
- [**Bug 1181475**](https://bugzilla.mozilla.org/show_bug.cgi?id=1181475) - [e10s] Shift + back/forward button opens page in a new window but renders blank - [Notes](https://www.evernote.com/l/AbI1HRmyPIhHjIMZ2Cx5QDAQ16hcfQrmBdo)
- [**Bug 1180878**](https://bugzilla.mozilla.org/show_bug.cgi?id=1180878) - [e10s] Can't Print to PDF if folder name contains spaces
